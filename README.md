...
### 1. Java Microservice (Port 8080)
*Requires `JDK 17` and `mvnd`.*

```powershell
# Open terminal in project root
cd java-token-system

# Set JAVA_HOME and run with mvnd
$env:JAVA_HOME="C:\Program Files\Java\jdk-17"
& "C:\maven-mvnd-1.0.3-windows-amd64\bin\mvnd.exe" clean spring-boot:run
```

### 2. Python Gateway (Port 8000)
*Requires `Python 3.x`.*
...
### 3. Flutter App
*Requires `Flutter SDK` and `Android Emulator/Device`.*
